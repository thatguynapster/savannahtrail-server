...
import {
  CreatereateBookingValidate,
  UpdateBookingValidate,
} from "../validators/booking";
import {
  aggregatePaginateBookings,
  createBooking,
  deleteBooking,
  getAllBookings,
  getOneBooking,
...
export const paginateBookingsController = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const reassignBookedGuide = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
